...
write_xlsx(deg, "deg_GSE51981.xlsx")
...
write_xlsx(up_genes, "deg_GSE51981_up_genes.xlsx")
write_xlsx(down_genes, "deg_GSE51981_down_genes.xlsx")
...
write_xlsx(as.data.frame(go_result_BP), "deg_GSE51981_GO_BP_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_MF), "deg_GSE51981_GO_MF_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_CC), "deg_GSE51981_GO_CC_enrichment.xlsx")
...
write_xlsx(as.data.frame(kegg_enrich), "deg_GSE51981_KEGG_enrichment.xlsx")
...
write_xlsx(as.data.frame(reactome_enrich), "deg_GSE51981_reactome_enrichment.xlsx")
...
pheatmap(xcell_result, 
         main = "xCell Immune Infiltration - GSE51981",
         scale = "row",
         clustering_distance_rows = "euclidean",
         clustering_distance_cols = "euclidean")

write_xlsx(xcell_df, "deg_GSE51981_xCell_Results.xlsx")
...
write_xlsx(stat_tests, "deg_GSE51981_xcell_stat_tests.xlsx")
...
ggplot(long_xcell, aes(x = group, y = proportion, fill = group)) +
  ...
  theme_minimal() +
  labs(title = "Immune Cell Infiltration (xCell) - GSE51981") +
