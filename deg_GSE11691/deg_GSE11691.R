...
write_xlsx(up_genes, "deg_GSE11691_up_genes.xlsx")
write_xlsx(down_genes, "deg_GSE11691_down_genes.xlsx")
...
write_xlsx(as.data.frame(go_result_BP), "deg_GSE11691_GO_BP_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_MF), "deg_GSE11691_GO_MF_enrichment.xlsx")
...
write_xlsx(as.data.frame(go_result_CC), "deg_GSE11691_GO_CC_enrichment.xlsx")
...
write_xlsx(as.data.frame(kegg_enrich), "deg_GSE11691_KEGG_enrichment.xlsx")
...
pheatmap(xcell_result, 
         main = "xCell Immune Infiltration - GSE11691",
         scale = "row",
         clustering_distance_rows = "euclidean",
         clustering_distance_cols = "euclidean")

write_xlsx(xcell_df, "deg_GSE11691_xCell_Results.xlsx")
...
write_xlsx(stat_tests, "deg_GSE11691_xcell_stat_tests.xlsx")
...
ggplot(long_xcell, aes(x = group, y = proportion, fill = group)) +
  ...
  theme_minimal() +
  labs(title = "Immune Cell Infiltration (xCell) - GSE11691") +
